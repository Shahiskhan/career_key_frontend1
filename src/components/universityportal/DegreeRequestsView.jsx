...
import { FiSearch, FiFilter, FiEye, FiCheckCircle, FiXCircle, FiLoader, FiDownload, FiInfo } from 'react-icons/fi';
...
const DegreeRequestsView = () => {
    ...
    const handleVerify = async (requestId) => {
        ...
        if (!requestId) {
            alert("Error: Degree Request ID is missing.");
            return;
        }
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                {req.documentPath && (
                                                    <a
                                                        href={`http://localhost:9090${req.documentPath}`}
                                                        target="_blank"
